...
class MachO(KaitaiStruct):
    ...
    class SourceVersionCommand(KaitaiStruct):
        ...
        def _read(self):
            self.version_packed = self._io.read_u8le()

        @property
        def patch_2(self):
            if hasattr(self, '_m_patch_2'):
                return self._m_patch_2 if hasattr(self, '_m_patch_2') else None

            self._m_patch_2 = ((self.version_packed >> 10) & 1023)
            return self._m_patch_2 if hasattr(self, '_m_patch_2') else None

        @property
        def patch_1(self):
            if hasattr(self, '_m_patch_1'):
                return self._m_patch_1 if hasattr(self, '_m_patch_1') else None

            self._m_patch_1 = ((self.version_packed >> 20) & 1023)
            return self._m_patch_1 if hasattr(self, '_m_patch_1') else None
        ...
        def major(self):
            ...
            self._m_major = (self.version_packed >> 40)
            return self._m_major if hasattr(self, '_m_major') else None
        ...
        def minor(self):
            ...
            self._m_minor = ((self.version_packed >> 30) & 1023)
            return self._m_minor if hasattr(self, '_m_minor') else None

        @property
        def patch_3(self):
            if hasattr(self, '_m_patch_3'):
                return self._m_patch_3 if hasattr(self, '_m_patch_3') else None

            self._m_patch_3 = (self.version_packed & 1023)
            return self._m_patch_3 if hasattr(self, '_m_patch_3') else None

        def __str__(self):
            return '{}.{}.{}.{}.{}'.format(self.major, self.minor, self.patch_1, self.patch_2, self.patch_3)
    ...
    class BuildVersionCommand(KaitaiStruct):
        ...
        def _read(self):
            self.platform = self._root.BuildVersionCommand.PlatformType(self._io.read_u4le())
            self.minos = self._root.Version(self._io, self, self._root)
